...
const double VAD_RMS_THRESHOLD = 0.002;
...
bool is_speech(const float* data, size_t n, double rms_threshold) {
    ...
    const double ZCR_MIN = 0.02;
    const double ZCR_MAX = 0.9;
...
void Enrollment_thread()
{
    ...
    while (!stop_flag) {
        ...
        while (!stop_flag) {
            ...
            double adaptive_threshold = update_adaptive_rms_threshold(current_rms, recent_rms, 20, 1.5);
